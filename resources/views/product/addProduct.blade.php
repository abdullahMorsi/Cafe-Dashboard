...
<x-side-links/>
    ...
    <div class="content" style="height: fit-content; top:67px">
        <h3 style="font-size: 20px; font-weight: 600;">اضافة منتج جديد</h3>
        <p style="color:#b9b0b0;font-size: 14px; ">هذا النص هو مثال لنص يمكن ان يستبل مكانه</p>

        <div class="addProduct">

            <form method="post" class="form2" action="/products" enctype="multipart/form-data">
                @csrf
                <label for="">اسم المنتج</label>
                <input type="text" name="name" placeholder="برجاء ادخال عنوان المنتج">

                <label for="">السعر</label>
                <input type="text" name="price" placeholder="برجاء ادخال السعر">

                <label for="">وصف المنتج</label>
                <textarea name='details' placeholder="برجاء ادخال وصف المنتج"></textarea>
